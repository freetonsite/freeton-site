...
$opt_name = 'tonsitemaster-option';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = array(
	...
	'menu_title'                => esc_html__( 'Sample Options', 'tonsitemaster' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Sample Options', 'tonsitemaster' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'General', 'tonsitemaster' ),
		'id'               => 'general-section',
		'desc'             => esc_html__( 'General Settings', 'tonsitemaster' ),
        'fields'           => array(
                'id'       => 'footer-copy',   
                'type'     => 'text',
                'title'    => esc_html__('Footer copy','tonsitemaster'),
                'default'  => ''
                ),
	)
);
